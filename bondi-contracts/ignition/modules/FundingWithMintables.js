...
exports.default = (0, modules_1.buildModule)("FundingWithMintables", (m) => {
    const minimumInvestmentAmount = m.getParameter("minimumInvestmentAmount", BigInt(process.env.MINIMUM_INVESTMENT_AMOUNT || "1000000"));
    const targetAmount = m.getParameter("targetAmount", BigInt(process.env.TARGET_AMOUNT || "100000000"));
